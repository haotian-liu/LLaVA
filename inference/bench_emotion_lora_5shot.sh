...
#PBS -N bench_emotion_lora_fewshot
...
python -m llava.eval.model_vqa \
    ...
    --answers-file /home/users/ntu/chih0001/scratch/VLM/SGLang/benchmark/llava_bench/answers/FED/lora_fewshot_answers_FED_1.5-7b_new.jsonl \
    --conv-mode vicuna_v1 \
    --temperature 0 