...
#PBS -N bench_fatigue_lora_fewshot
...
python -m llava.eval.model_vqa \
    ...
    --answers-file /home/users/ntu/chih0001/scratch/VLM/SGLang/benchmark/llava_bench/answers/NTHU-DDD/lora_fewshot_answers_NTHU-DDD_1.5-7b_new.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1
