...
python -m llava.eval.model_vqa \
    ...
    --answers-file /home/users/ntu/chih0001/scratch/VLM/sglang/benchmark/llava_bench/answers/NTHU-DDD/answers_NTHU-DDD_1.6-mistral-7b.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1
