...
def preprocess_multimodal(
    ...
    # TODO: does this always move the image to the front of the turn? (and is that
    # desirable?  perhaps you'd want to conditionally process the image)
...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        if 'mpt' in model_args.model_name_or_path:
        ...
        elif 'baichuan' in model_args.model_name_or_path:
            kwargs = {
                "cache_dir": training_args.cache_dir,
            ...
            model = DelegatingLlavaForCausalLM(
                config, training_args.device, **kwargs
            )
        else:
    ...
    if model_args.version == "v0":
        ...
        if model_args.version in conversation_lib.conv_templates:
            ...
            assert 'baichuan' not in model_args.version
