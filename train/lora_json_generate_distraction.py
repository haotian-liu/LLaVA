...
def main():
    ...
    samples = collect_samples(distraction_dir, "distraction", distraction_question, distraction_labels)

    output_path = "/home/users/ntu/chih0001/scratch/VLM/LLaVA/train/lora_distraction.json"
