...
deepspeed --include=localhost:$GPUS --master_port $PORT \
    ...
    --bf16 True \
    --output_dir ./checkpoints/deepspeed_llava-7b-$WEIGHT_VERSION-pretrain_blip558k-lightning_finetune \
    --num_train_epochs 1 \
...
deepspeed --include=localhost:$GPUS --master_port $PORT \
    ...
    --mm_use_im_start_end True \
    --bf16 True \
    --output_dir ./checkpoints/deepspeed_llava-7b-$WEIGHT_VERSION-pretrain_blip558k-lightning_finetune_lora \
    --num_train_epochs 1 \
    --per_device_train_batch_size 4 \
    --per_device_eval_batch_size 4 \
    --gradient_accumulation_steps 1 \
...
deepspeed --include=localhost:$GPUS --master_port $PORT \
    ...
    --mm_use_im_start_end True \
    --bf16 True \
    --output_dir ./checkpoints/deepspeed_llava-7b-$WEIGHT_VERSION-pretrain_blip558k-lightning_finetune_3e \
    --num_train_epochs 3 \
    --per_device_train_batch_size 4 \
    --per_device_eval_batch_size 4 \
    --gradient_accumulation_steps 1 \
...
deepspeed --include=localhost:$GPUS --master_port $PORT \
    ...
    --mm_use_im_start_end True \
    --bf16 True \
    --output_dir ./checkpoints/deepspeed_llava-7b-$WEIGHT_VERSION-pretrain_blip558k-lightning_finetune_lora_3e \
    --num_train_epochs 3 \
    --per_device_train_batch_size 4 \
    --per_device_eval_batch_size 4 \
    --gradient_accumulation_steps 1 \
