...
# 2x32x2 (failed for 13b)
# 2x16x4 
deepspeed llava/train/train_mem.py \
    --lora_enable True --lora_r 128 --lora_alpha 256 --mm_projector_lr 2e-5 \
    --deepspeed ./scripts/zero3.json \
    --model_name_or_path /home/users/ntu/chih0001/scratch/model/llava-v1.6-vicuna-13b \
    --version v1 \
    ...
    --bf16 True \
    --output_dir /home/users/ntu/chih0001/scratch/model/lora/globalBS/llava-v1.6-vicuna-13b-DSLLM-lora \
    --num_train_epochs 1 \
...
#     --group_by_modality_length True \
#     --bf16 True \
#     --output_dir /home/users/ntu/chih0001/scratch/model/lora/llava-v1.6-vicuna-13b-DSLLM-lora \
#     --num_train_epochs 1 \
#     --per_device_train_batch_size 16 \
#     --per_device_eval_batch_size 4 \
