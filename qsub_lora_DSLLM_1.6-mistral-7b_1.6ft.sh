...
deepspeed llava/train/train_mem.py \
    ...
    --model_name_or_path /home/users/ntu/chih0001/scratch/model/llava-v1.6-mistral-7b \
    --version v1 \
    ...
    --bf16 False \
    --fp16 True \
    --output_dir /home/users/ntu/chih0001/scratch/model/lora/globalBS/llava-v1.6-mistral-7b-DSLLM-lora_ft1.6 \
    --num_train_epochs 1 \
...
#     --bf16 True \
#     --output_dir /home/users/ntu/chih0001/scratch/model/lora/noglobalBS/llava-v1.6-mistral-7b-DSLLM-lora \
#     --num_train_epochs 1 \
#     --per_device_train_batch_size 16 \
#     --per_device_eval_batch_size 4 \
