...
deepspeed llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /home/users/ntu/chih0001/scratch/VLM/LLaVA/train/lora_fewshot.json \
    ...
    --bf16 True \
    --output_dir /home/users/ntu/chih0001/scratch/model/lora/globalBS/llava-v1.5-7b-DSLLM-lora_fewshot \
    --num_train_epochs 1 \
...
#     --group_by_modality_length True \
#     --bf16 True \
#     --output_dir /home/users/ntu/chih0001/scratch/model/lora/noglobalBS/llava-v1.5-7b-DSLLM-lora \
#     --num_train_epochs 1 \
